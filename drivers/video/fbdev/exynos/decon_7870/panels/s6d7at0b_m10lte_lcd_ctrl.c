...
#include "mdnie.h"
#include "mdnie_lite_table_m10lte.h"
#endif
...
static int s6d7at0b_init(struct lcd_info *lcd)
{
	...
	if(board_id == 0) {
		DSI_WRITE(SEQ_S6D7AT0B_w00_71, ARRAY_SIZE(SEQ_S6D7AT0B_w00_71));
		DSI_WRITE(SEQ_S6D7AT0B_w00_73, ARRAY_SIZE(SEQ_S6D7AT0B_w00_73));
		DSI_WRITE(SEQ_S6D7AT0B_w00_B1, ARRAY_SIZE(SEQ_S6D7AT0B_w00_B1));
		DSI_WRITE(SEQ_S6D7AT0B_w00_B3, ARRAY_SIZE(SEQ_S6D7AT0B_w00_B3));
		DSI_WRITE(SEQ_S6D7AT0B_w00_BA, ARRAY_SIZE(SEQ_S6D7AT0B_w00_BA));
		DSI_WRITE(SEQ_S6D7AT0B_w00_BB, ARRAY_SIZE(SEQ_S6D7AT0B_w00_BB));
		DSI_WRITE(SEQ_S6D7AT0B_w00_EC, ARRAY_SIZE(SEQ_S6D7AT0B_w00_EC));
		DSI_WRITE(SEQ_S6D7AT0B_w00_ED, ARRAY_SIZE(SEQ_S6D7AT0B_w00_ED));
		DSI_WRITE(SEQ_S6D7AT0B_w00_EE, ARRAY_SIZE(SEQ_S6D7AT0B_w00_EE));
		DSI_WRITE(SEQ_S6D7AT0B_w00_EF, ARRAY_SIZE(SEQ_S6D7AT0B_w00_EF));
		DSI_WRITE(SEQ_S6D7AT0B_w00_F2, ARRAY_SIZE(SEQ_S6D7AT0B_w00_F2));
		DSI_WRITE(SEQ_S6D7AT0B_w00_B0, ARRAY_SIZE(SEQ_S6D7AT0B_w00_B0));
		DSI_WRITE(SEQ_S6D7AT0B_w00_F4, ARRAY_SIZE(SEQ_S6D7AT0B_w00_F4));
		DSI_WRITE(SEQ_S6D7AT0B_w00_F9, ARRAY_SIZE(SEQ_S6D7AT0B_w00_F9));
		DSI_WRITE(SEQ_S6D7AT0B_w00_FE, ARRAY_SIZE(SEQ_S6D7AT0B_w00_FE));
		DSI_WRITE(SEQ_S6D7AT0B_w00_C0, ARRAY_SIZE(SEQ_S6D7AT0B_w00_C0));
		DSI_WRITE(SEQ_S6D7AT0B_w00_C1, ARRAY_SIZE(SEQ_S6D7AT0B_w00_C1));
		DSI_WRITE(SEQ_S6D7AT0B_w00_C8, ARRAY_SIZE(SEQ_S6D7AT0B_w00_C8));
		DSI_WRITE(SEQ_S6D7AT0B_w00_E8, ARRAY_SIZE(SEQ_S6D7AT0B_w00_E8));
	} else {
